...
df_melt_profile_filtered = df_melt_profile[
    ~df_melt_profile["batch"].isin([21, 94, 95])
].copy()
print(
    f"Number of batches after filtering (excluding B21, B94): {len(df_melt_profile_filtered)}"
)
print(f"Excluded batches: B21, B94\n")
...
fig_scatter.update_layout(
    title="Energy Consumption vs Time Duration (Interactive, Excluding B21, B94)",
...
print("\n" + "=" * 60)
print("BATCH ANALYSIS SUMMARY (Excluding B21, B94)")
print("=" * 60)
